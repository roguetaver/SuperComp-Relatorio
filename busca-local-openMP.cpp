...
int main()
{
    ...
    #pragma omp parallel for shared(bestSeqB) reduction(max: best_score)
    for (int i = 0; i < p; i++)
    {
...
// g++ -Wall -O3 -fopenmp busca-local-openMP.cpp -o busca-local-openMP
// ./busca-local-openMP < dna.seq